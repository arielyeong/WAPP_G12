...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="table table-bordered table-hover table-success">
        <tr>
            <td style="width: 606px">Full Name</td>
            <td><asp:TextBox ID="txtFullname" runat="server" CssClass="form-control"></asp:TextBox></td>
        </tr>
        <tr>
            <td style="width: 606px">Email Address</td>
            <td><asp:TextBox ID="txtEmail" runat="server" TextMode="Email" CssClass="form-control"></asp:TextBox></td>
        </tr>
        <tr>
            <td style="width: 606px">Username</td>
            <td><asp:TextBox ID="TextBox1" runat="server" CssClass="form-control"></asp:TextBox></td>
        </tr>
        <tr>
            <td style="width: 606px">Password</td>
            <td><asp:TextBox ID="txtPassword" runat="server" TextMode="Password" CssClass="form-control"></asp:TextBox></td>
        </tr>
        <tr>
            <td style="width: 606px">Confirm Password</td>
            <td><asp:TextBox ID="txtConPass" runat="server" TextMode="Password" CssClass="form-control"></asp:TextBox></td>
        </tr>
        <tr>
            <td style="width: 606px">Age:</td>
            <td><asp:TextBox ID="txtAge" runat="server" TextMode="Number" CssClass="form-control"></asp:TextBox>
</td>
        </tr>
        <tr>
            <td style="width: 606px">Gender</td>
            <td><asp:RadioButtonList ID="RadioButtonList1" runat="server" CssClass="form-control">
            <asp:ListItem>Male</asp:ListItem>
            <asp:ListItem>Female</asp:ListItem>
            </asp:RadioButtonList></td>
        </tr>
        <tr>
            <td style="width: 606px">Country</td>
            <td><asp:DropDownList ID="dlCountry" runat="server" CssClass="form-control">
        ...
        <tr>
            <td style="width: 606px">Picture</td>
            <td><asp:FileUpload ID="FileUploadPic" runat="server" CssClass="form-control" /></td> 

        </tr>
        <tr>
            <td style="width: 606px">This will be hidden later</td>
            <td> <asp:Label ID="lblDTRegistered" runat="server" Text="Label"></asp:Label></td>
        </tr>
        <tr>
            <td style="width: 606px"></td>
            <td><asp:Button ID="btnRegister" runat="server" Text="Register" CssClass="btn btn-danger" OnClick="btnRegister_Click" /></td>
        </tr>
